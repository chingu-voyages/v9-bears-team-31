...
let AppComponent = class AppComponent {
    constructor(changeDetectorRef, media, toast, webService, router) {
        this.toast = toast;
...
/* harmony import */ var ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ngx-bootstrap/dropdown */ "./node_modules/ngx-bootstrap/dropdown/fesm2015/ngx-bootstrap-dropdown.js");
...
/* harmony import */ var angular_font_awesome__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! angular-font-awesome */ "./node_modules/angular-font-awesome/dist/angular-font-awesome.js");
...
let LoginComponent = class LoginComponent {
    constructor(router, route, formBuilder, webServivce, toastr) {
        this.router = router;
        this.route = route;
...
let RegisterComponent = class RegisterComponent {
    constructor(win, router, route, formBuilder, service, cd, toastr) {
        this.win = win;
        this.router = router;
        this.route = route;
        this.formBuilder = formBuilder;
    ...
    ngOnInit() {
        ...
        const new_firebase = firebase__WEBPACK_IMPORTED_MODULE_7__;
    ...
    ngAfterViewInit() {
        ...
        const controlBlurs = this.fromInputElement.map((formControl) => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["fromEvent"])(formControl.nativeElement, 'blur'));
        Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["merge"])(this.verifyForm.valueChanges, ...controlBlurs)
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["merge"])(this.userRegistrationForm.valueChanges, ...controlBlurs)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(1000))
            .subscribe(() => {
...
let DashboardComponent = class DashboardComponent {
    constructor(webService, builder, dialog, router) {
        this.webService = webService;
    ...
    ngAfterViewInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"])(this.sort.sortChange, this.paginator.page)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(() => this.loadTaxiDataPage()))
            .subscribe();
    }
    loadTaxiDataPage() {
    ...
    openDialog() {
        const dialogRef = this.dialog.open(_taxi_new_component__WEBPACK_IMPORTED_MODULE_8__["TaxiNewComponent"], {
            width: '400px',
...
let TaxiDetailComponent = class TaxiDetailComponent {
    constructor(route, dialog, webService, router) {
        this.route = route;
        this.dialog = dialog;
        this.webService = webService;
        this.router = router;
    ...
    openDialog() {
        const dialogRef = this.dialog.open(_taxi_review_modal_component__WEBPACK_IMPORTED_MODULE_5__["TaxiReviewModalComponent"], {
            width: '300px',
            data: { taxi: this.taxi }
        });
        dialogRef.afterClosed().subscribe(result => {
...
let TaxiNewComponent = class TaxiNewComponent {
    constructor(builder, dialogRef, data, webService, toastr) {
        this.builder = builder;
        ...
        this.webService.rate(toReview)
            ...
            if (rateRes.success) {
                ...
                this.webService.taxi({
                    ...
                    .pipe(Object(_services__WEBPACK_IMPORTED_MODULE_4__["uploadProgress"])(progress => (this.progress = progress)), Object(_services__WEBPACK_IMPORTED_MODULE_4__["toResponseBody"])())
                    .subscribe((newTaxis) => {
                    this.progress = 0;
                    this.success = true;
                    this.loading = false;
...
let TaxiReviewModalComponent = class TaxiReviewModalComponent {
    constructor(builder, dialogRef, data, webService, toastr) {
        this.builder = builder;
        this.dialogRef = dialogRef;
        this.data = data;
...
let SafariBuddyInterceptor = class SafariBuddyInterceptor {
    constructor(inj) {
...
let TaxiResolver = class TaxiResolver {
    ...
    resolve(route, state) {
        ...
        return this.taxiService.getTaxi(numberPlate)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(taxi => {
            return { taxi };
...
let WebServiceService = class WebServiceService {
    ...
    login(context) {
        ...
        return this.http.post(`${this.url}/v1/login`, user)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((userResponse) => {
    ...
    rate(userRating) {
        return this.http.post(`${this.url}/v1/review`, userRating)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((rating) => {
    ...
    taxi(taxi) {
        return this.http.post(`${this.url}/v1/taxis`, toFormData(taxi), {
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((newTaxi) => {
    ...
    getTaxi(numberPlate) {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(data)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
    initializeTaxi() {
    ...
    notify(type, message, from, align) {
        $.notify({
            icon: 'notifications',
            message
        }, {
...
function uploadProgress(cb) {
    return Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((event) => {
...
function toResponseBody() {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["pipe"])(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((event) => event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpEventType"].Response), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((res) => res.body));
}
...
class GenericValidator {
    ...
    //     validationRuleName2: 'Validation Message.'
    // }
    static passwordPatternValidator(regex, error) {
        return (control) => {
    ...
    static matchPasswordValidator(control) {
        const password = control.get('password').value;
        const confirmPassword = control.get('confirmPassword').value;
        const touchedConfirm = control.get('confirmPassword').touched || control.get('confirmPassword').dirty;
        if (touchedConfirm) {
            if (password !== confirmPassword) {
